...
CREATE TABLE EMPLOYEES
    ...
    ALTER TABLE EMPLOYEES ADD CONSTRAINT fk_emp_01 FOREIGN KEY (JOB_ID) REFERENCES JOBS (JOB_ID);
...
CREATE TABLE JOB_HISTORY
    ...
    ALTER TABLE JOB_HISTORY ADD CONSTRAINT fk_job_h_02 FOREIGN KEY (DEPARTMENT_ID) REFERENCES DEPARTMENT (DEPARTMENT_ID);