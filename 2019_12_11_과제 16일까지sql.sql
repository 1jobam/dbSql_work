...
CREATE TABLE JOBS
    ...
    CONSTRAINT pk_job_01 PRIMARY KEY (JOB_ID)
    );
...
CREATE TABLE REGIONS
    ...
    CONSTRAINT pk_reg_01 PRIMARY KEY (REGION_ID)
    );
...
CREATE TABLE COUNTRIES
    ...
    CONSTRAINT pk_cout_01 PRIMARY KEY (COUNTRY_ID),
...
CREATE TABLE LOCATIONS
    ...
    CONSTRAINT pk_loc_01 PRIMARY KEY (LOCATION_ID),
...
CREATE TABLE DEPARTMENTS
    ...
    CONSTRAINT pk_dept_01 PRIMARY KEY (DEPARTMENT_ID),
...
CREATE TABLE EMPLOYEES
    ...
    ALTER TABLE EMPLOYEES ADD CONSTRAINT fk_emp_02 FOREIGN KEY (DEPARTMENT_ID) REFERENCES DEPARTMENTS (DEPARTMENT_ID);
...
CREATE TABLE JOB_HISTORY
    ...
    CONSTRAINT pk_job_h_00 PRIMARY KEY (EMPLOYEE_ID, START_DATE),
    CONSTRAINT fk_job_h_00 FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEES (EMPLOYEE_ID),
    CONSTRAINT fk_job_h_01 FOREIGN KEY (JOB_ID) REFERENCES JOBS (JOB_ID),
    CONSTRAINT fk_job_h_02 FOREIGN KEY (DEPARTMENT_ID) REFERENCES DEPARTMENTS (DEPARTMENT_ID)
    );