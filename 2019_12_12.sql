...
-- 다음과 같이 SQL으로 작성 할 수 있다.
-- SELECT *
-- FROM e;

--system 계정으로 진행 한사항
-- PC02계정에 SYNONYM 생성 권한을 부여
GRANT CREATE SYNONYM TO PC02;

--emp 테이블의 synonym e를 생성
-- CREAT SYNONYM 시노님 이름 FRO 오라클객체;
CREATE SYNONYM e for emp;

--emp 라는 테이블 명 대신에 e 라고 하는 시노님을 사용하여 쿼리를 작성 할수 있다.
SELECT *
FROM emp;
...
-- 동일한 SQL의 개념에 따르면 아래 SQL 들은 다르다
